...
export class UtcConvertPipe implements PipeTransform {
  ...
  data1: any = '';
  type:any='';
  transform(date1: any, type: any): any {
    return this.convertUTCDateToLocal(date1,type);  
  }
  ...
  displayDateVal:any;
  minutesval:any;
  convertUTCDateToLocal(date1, type) {​​​​​​
  let hrs: any;
  ...
  if (type == "L" || type == 'C')
  return this.displayMonthVal + '.' + this.displayDateVal + '.' + yearval.toString().substr(2, 4);
  else
  return this.displayMonthVal + '.' + this.displayDateVal + '.' + yearval.toString().substr(2, 4) + ' @ ' + hrsformat;
   }​​​​​​
   }​​​​​​
  else {​​​​​​
  if (type == "L" || type == "C")
